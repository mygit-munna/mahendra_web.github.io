...
if (!class_exists('\Tablesome\Workflow_Library\Actions\Tablesome_Add_Row_Old')) {
    class Tablesome_Add_Row_Old extends Action
    {
        ...
        public function do_action($trigger_class, $trigger_instance)
        {
            ...
            // $new_add_row = new \Tablesome\Workflow_Library\Experiments\Tablesome_Add_Row_Boilerplate();
            // $new_add_row->do_action($trigger_class, $trigger_instance);
            // return;
