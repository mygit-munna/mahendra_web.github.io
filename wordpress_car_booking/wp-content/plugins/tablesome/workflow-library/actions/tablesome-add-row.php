    ...
    class Tablesome_Add_Row extends Action
    {
        ...
        private function get_row_values($event_params)
        {
            ...
            foreach ($fields_map as $field_set) {
                ...
                $field_value = isset($source_data[$field_name]['final_value']) ? $source_data[$field_name]['final_value'] : '';
        ...
        private function check_and_insert_table_row($row_values, $event_params)
        {
            ...
            $result = $tablesome_db->insert($query, $insert_record_data, $conditional_args);
            return $result;
        }
            ...
            foreach ($fields_map as $key => $field_set) {
                ...
                if ($column == false) {
                    ...
                    $event_params['table_columns'][] = array(
                        ...
                        'name' => $name,
                        'format' => $this->get_column_type($field_set['field_name'], $event_params),
                    );
        ...
        private function get_column_type($field_name, $event_params)
        {
            ...
            $field_type = $event_params['source_data'][$field_name]['type'];
